...
def basico():
    """
    Hace la parte basica de la factura, que es igual para todas y refiere
    al hotel de nuestra aplicacion.
    :return: void
    """
    try:
        global bill
...
def factura(datosfactura):
    """
    Se le cargan los datos de la reserva para imprimir la factura concreta y se almacena en un lugar definido
    en la misma.
    :param datosfactura:
    :return: void
    """
